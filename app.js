...
deleteButtonImg.classList.add('list-item__img')
    label.innerText=taskString;
    label.className = 'task';
    label.classList.add('list-item__task')
    ...
    editInput.classList.add('list-item__input-task')
...
var taskCompleted=function(){
    ...
    label.classList.remove('incomplete-list__task')
    label.classList.add('completed-list__task')
    listItem.classList.remove('incomplete-list__item')
    listItem.classList.remove('completed-list__item')
...
//Mark task as incomplete.
    ...
    listItem.classList.remove('completed-list__item')
    listItem.classList.add('incomplete-list__item')
    label.classList.remove('completed-list__task')
    label.classList.add('incomplete-list__task')
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
